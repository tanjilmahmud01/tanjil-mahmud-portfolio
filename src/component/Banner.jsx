      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12">
          ...
          <div className="flex-1 text-center font-secondary lg:text-left">
            ...
            >
              Web Programmer with experience in React JS to develop and maintain
              full-stack responsive websites. Keen to work collaboratively to
              achieve organizational excellence, maintaining timeline and
              budget. Keeping up with the everchanging technology stacks to hone
